...
const car33 = inventory[32].car_make;
const model33 = inventory[32].car_model;
const year33 = inventory[32].car_year;
console.log("Car 33 is a " + year33 + " " + car33 + " " + model33 + ".");
...
let lastCar = 0;
const carFinal = inventory[inventory.length - 1].car_make;
const modelFinal = inventory[inventory.length - 1].car_model;
lastCar = carFinal + " " + modelFinal;
console.log(lastCar);
